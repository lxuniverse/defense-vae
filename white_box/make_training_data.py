...
with tf.Session() as sess:
    ...
    if args.attack_method == 1:
        ...
        savedir = base_savedir + 'AdvSave/FGSM/model_{}/cnnEpochs_{}/epsilon_{}/'.format(args.cnn_model, args.cnn_epochs, args.epsilon)
        ...
        attack_obj = FastGradientMethod(model, sess=sess)
        savedir = base_savedir + 'AdvSave/RANDFGSM/model_{}/cnnEpochs_{}/epsilon_{}/'.format(args.cnn_model, args.cnn_epochs, args.epsilon)
        ...
        savedir = base_savedir + 'AdvSave/CW/model_{}/cnnEpochs_{}/epsilon_{}/'.format(args.cnn_model, args.cnn_epochs, args.epsilon)
