...
load_dir = '../white_box/' + base_savedir + 'vae_model_lambda/init_multi/vaeModel_{}/cnnModel_{}/epochs_{}/lr_{}/' \
                                            'batchSize_{}/multi_{}/rBegin_{}/rEnd_{}/sigmoid_{}/siglambda_{}/init1_{}/int2_{}/init3_{}/int4_{}/'.format(
    args.vae_model, args.cnn_model_bb, args.train_epochs,
...
if args.attack_method == 1:
    savedir = base_savedir + 'AdvSave_test/FGSM/modelbb_{}/modelsub_{}/cnnEpochs_{}/epsilon_{}/'.format(args.cnn_model_bb,args.cnn_model_sub, 20, args.test_epsilon)
...
if args.attack_method ==1:
    rec_dir = base_savedir + 'rec_lambda_multi/init/vaeModel_{}/cnnModelbb_{}/cnnModelsub_{}/train_epoch_{}/model_epoch_{}/lr_{}/' \
                             'batchSize_{}/trainEps_{}/testEps_{}/rBegin_{}/rEnd_{}/sigmoid_{}/siglambda_{}/'.format(
