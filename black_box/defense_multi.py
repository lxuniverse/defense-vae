...
if args.attack_method ==1:
    rec_dir = base_savedir + 'rec_lambda_multi/init/vaeModel_{}/cnnModelbb_{}/cnnModelsub_{}/train_epoch_{}/model_epoch_{}/lr_{}/batchSize_{}/trainEps_{}/testEps_{}/rBegin_{}/rEnd_{}/sigmoid_{}/siglambda_{}/'.format(
        args.vae_model, args.cnn_model_bb, args.cnn_model_sub,args.train_epochs, args.model_epochs,
        args.lr, args.batch_size,args.train_epsilon, args.test_epsilon,args.r_begin,args.r_end,args.sigmoid,args.sigmoid_lambda)

adv_x_recon = np.load(rec_dir + 'rec.npy')
adv_x_recon = adv_x_recon.transpose(0, 2, 3, 1)

### read lable
savedir = base_savedir + 'AdvSave_test/FGSM/modelbb_{}/modelsub_{}/cnnEpochs_{}/epsilon_{}/'.format(args.cnn_model_bb, args.cnn_model_sub,args.cnn_epochs, 0.3)
...
cnn_dir = '../cnn_models/' + base_savedir + 'CNN_model_{}/'.format(args.cnn_model_bb)
sess = tf.Session(config=tf.ConfigProto(**config_args))
if args.cnn_model_bb == 1:
    model = model_a()
elif args.cnn_model_bb == 2:
    model = model_b()
elif args.cnn_model_bb == 3:
    model = model_c()
elif args.cnn_model_bb == 4:
    model = model_d()
...
message = 'black-box defense accuracy on CNN model_{} + substitute model_{} + attack_{} is: {}'.format(args.cnn_model_bb, args.cnn_model_sub, args.attack_method, acc)
print(message)
